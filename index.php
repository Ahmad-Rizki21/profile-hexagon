                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-offset-1 col-md-10 col-lg-offset-2 col-lg-8">
                            <div class="page-title home text-center">
                                <img src="img/AHMAD RIZKI' PROFILE.png" alt="">
                                <p>Saya seorang front end developer dan seorang freelancer &amp; untuk mengetahui
                                    selengkapnya bisa mengklik icon di bawah ini.</p>
                            </div>
